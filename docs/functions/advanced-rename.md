...
### 9.5 输出格式（Separator + Numbering）

字段卡片下方有一行：

```
Separator: [_]   ☐ Numbering
```
...
```
[Filter regions/markers...     ]  ☐ Regions  ☐ Markers   [All] [Inv] [Clr]
┌─┬─────────────────────────────┬──────────┐
│☑│ ▌ Intro                     │ 00:00.000│
├─┼─────────────────────────────┼──────────┤
│☐│ ▌ Verse                     │ 00:32.500│
...
### 13.1 Set Name 是规则链的输入起点，不是输出覆盖
...
### 13.10 R&M 模式下 List Rename 的 Group by Track 无意义
